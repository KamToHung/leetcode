...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [哈希表](https://leetcode-cn.com/tag/hash-table) [字符串](https://leetcode-cn.com/tag/string) [矩阵](https://leetcode-cn.com/tag/matrix) [模拟](https://leetcode-cn.com/tag/simulation) 