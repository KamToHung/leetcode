...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [树状数组](https://leetcode-cn.com/tag/binary-indexed-tree) [二分查找](https://leetcode-cn.com/tag/binary-search) [数据流](https://leetcode-cn.com/tag/data-stream) 