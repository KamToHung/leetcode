...
**标签:**  [队列](https://leetcode-cn.com/tag/queue) [滑动窗口](https://leetcode-cn.com/tag/sliding-window) [单调队列](https://leetcode-cn.com/tag/monotonic-queue) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 