...
**标签:**  [树](https://leetcode-cn.com/tag/tree) [深度优先搜索](https://leetcode-cn.com/tag/depth-first-search) [广度优先搜索](https://leetcode-cn.com/tag/breadth-first-search) [设计](https://leetcode-cn.com/tag/design) [字符串](https://leetcode-cn.com/tag/string) [二叉树](https://leetcode-cn.com/tag/binary-tree) 