...
**标签:**  [树](https://leetcode-cn.com/tag/tree) [广度优先搜索](https://leetcode-cn.com/tag/breadth-first-search) [设计](https://leetcode-cn.com/tag/design) [二叉树](https://leetcode-cn.com/tag/binary-tree) 