...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [队列](https://leetcode-cn.com/tag/queue) [数组](https://leetcode-cn.com/tag/array) [数据流](https://leetcode-cn.com/tag/data-stream) 