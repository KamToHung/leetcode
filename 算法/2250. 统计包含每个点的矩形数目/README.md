...
**标签:**  [树状数组](https://leetcode-cn.com/tag/binary-indexed-tree) [数组](https://leetcode-cn.com/tag/array) [二分查找](https://leetcode-cn.com/tag/binary-search) [排序](https://leetcode-cn.com/tag/sorting) 