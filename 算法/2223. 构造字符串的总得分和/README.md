...
**标签:**  [字符串](https://leetcode-cn.com/tag/string) [二分查找](https://leetcode-cn.com/tag/binary-search) [字符串匹配](https://leetcode-cn.com/tag/string-matching) [后缀数组](https://leetcode-cn.com/tag/suffix-array) [哈希函数](https://leetcode-cn.com/tag/hash-function) [滚动哈希](https://leetcode-cn.com/tag/rolling-hash) 