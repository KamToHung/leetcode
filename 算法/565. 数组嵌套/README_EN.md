...
### Similar Questions
 - Medium:	[Nested List Weight Sum](https://leetcode-cn.com/problems/nested-list-weight-sum) 
 - Medium:	[Flatten Nested List Iterator](https://leetcode-cn.com/problems/flatten-nested-list-iterator) 
 - Medium:	[Nested List Weight Sum II](https://leetcode-cn.com/problems/nested-list-weight-sum-ii) 
