...
# [1916. Count Ways to Build Rooms in an Ant Colony](https://leetcode-cn.com/problems/count-ways-to-build-rooms-in-an-ant-colony)
 ### Description
...
**Related Topics**  [Tree](https://leetcode-cn.com/tag/tree) [Graph](https://leetcode-cn.com/tag/graph) [Topological Sort](https://leetcode-cn.com/tag/topological-sort) [Math](https://leetcode-cn.com/tag/math) [Dynamic Programming](https://leetcode-cn.com/tag/dynamic-programming) [Combinatorics](https://leetcode-cn.com/tag/combinatorics) 