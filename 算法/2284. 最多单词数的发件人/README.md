...
# [2284. 最多单词数的发件人](https://leetcode-cn.com/problems/sender-with-largest-word-count)
...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [哈希表](https://leetcode-cn.com/tag/hash-table) [字符串](https://leetcode-cn.com/tag/string) [计数](https://leetcode-cn.com/tag/counting) 