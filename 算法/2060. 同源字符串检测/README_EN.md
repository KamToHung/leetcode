...
# [2060. Check if an Original String Exists Given Two Encoded Strings](https://leetcode-cn.com/problems/check-if-an-original-string-exists-given-two-encoded-strings)
 ### Description
