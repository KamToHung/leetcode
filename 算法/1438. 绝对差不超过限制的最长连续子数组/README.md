...
**标签:**  [队列](https://leetcode-cn.com/tag/queue) [数组](https://leetcode-cn.com/tag/array) [有序集合](https://leetcode-cn.com/tag/ordered-set) [滑动窗口](https://leetcode-cn.com/tag/sliding-window) [单调队列](https://leetcode-cn.com/tag/monotonic-queue) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 