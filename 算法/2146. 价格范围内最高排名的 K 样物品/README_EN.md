...
# [2146. K Highest Ranked Items Within a Price Range](https://leetcode-cn.com/problems/k-highest-ranked-items-within-a-price-range)
 ### Description
...
**Related Topics**  [Breadth-First Search](https://leetcode-cn.com/tag/breadth-first-search) [Array](https://leetcode-cn.com/tag/array) [Matrix](https://leetcode-cn.com/tag/matrix) [Sorting](https://leetcode-cn.com/tag/sorting) [Heap (Priority Queue)](https://leetcode-cn.com/tag/heap-priority-queue) 