...
# [1687. Delivering Boxes from Storage to Ports](https://leetcode-cn.com/problems/delivering-boxes-from-storage-to-ports)
 ### Description
...
**Related Topics**  [Segment Tree](https://leetcode-cn.com/tag/segment-tree) [Queue](https://leetcode-cn.com/tag/queue) [Array](https://leetcode-cn.com/tag/array) [Dynamic Programming](https://leetcode-cn.com/tag/dynamic-programming) [Monotonic Queue](https://leetcode-cn.com/tag/monotonic-queue) [Heap (Priority Queue)](https://leetcode-cn.com/tag/heap-priority-queue) 