...
**标签:**  [线段树](https://leetcode-cn.com/tag/segment-tree) [队列](https://leetcode-cn.com/tag/queue) [数组](https://leetcode-cn.com/tag/array) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [单调队列](https://leetcode-cn.com/tag/monotonic-queue) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 