...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [记忆化搜索](https://leetcode-cn.com/tag/memoization) [数学](https://leetcode-cn.com/tag/math) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [状态压缩](https://leetcode-cn.com/tag/bitmask) [博弈](https://leetcode-cn.com/tag/game-theory) 
 ### 相似题目
...
- 中等:	[预测赢家](https://leetcode-cn.com/problems/predict-the-winner) 
