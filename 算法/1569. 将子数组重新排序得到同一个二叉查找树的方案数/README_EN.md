...
# [1569. Number of Ways to Reorder Array to Get Same BST](https://leetcode-cn.com/problems/number-of-ways-to-reorder-array-to-get-same-bst)
 ### Description
...
**Related Topics**  [Tree](https://leetcode-cn.com/tag/tree) [Union Find](https://leetcode-cn.com/tag/union-find) [Binary Search Tree](https://leetcode-cn.com/tag/binary-search-tree) [Memoization](https://leetcode-cn.com/tag/memoization) [Array](https://leetcode-cn.com/tag/array) [Math](https://leetcode-cn.com/tag/math) [Divide and Conquer](https://leetcode-cn.com/tag/divide-and-conquer) [Dynamic Programming](https://leetcode-cn.com/tag/dynamic-programming) [Binary Tree](https://leetcode-cn.com/tag/binary-tree) [Combinatorics](https://leetcode-cn.com/tag/combinatorics) 