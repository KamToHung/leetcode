...
**标签:**  [树](https://leetcode-cn.com/tag/tree) [并查集](https://leetcode-cn.com/tag/union-find) [二叉搜索树](https://leetcode-cn.com/tag/binary-search-tree) [记忆化搜索](https://leetcode-cn.com/tag/memoization) [数组](https://leetcode-cn.com/tag/array) [数学](https://leetcode-cn.com/tag/math) [分治](https://leetcode-cn.com/tag/divide-and-conquer) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [二叉树](https://leetcode-cn.com/tag/binary-tree) [组合数学](https://leetcode-cn.com/tag/combinatorics) 