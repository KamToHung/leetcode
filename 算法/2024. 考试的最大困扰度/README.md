...
**标签:**  [字符串](https://leetcode-cn.com/tag/string) [二分查找](https://leetcode-cn.com/tag/binary-search) [前缀和](https://leetcode-cn.com/tag/prefix-sum) [滑动窗口](https://leetcode-cn.com/tag/sliding-window) 