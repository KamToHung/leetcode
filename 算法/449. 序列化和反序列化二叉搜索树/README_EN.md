...
**Related Topics**  [Tree](https://leetcode-cn.com/tag/tree) [Depth-First Search](https://leetcode-cn.com/tag/depth-first-search) [Breadth-First Search](https://leetcode-cn.com/tag/breadth-first-search) [Design](https://leetcode-cn.com/tag/design) [Binary Search Tree](https://leetcode-cn.com/tag/binary-search-tree) [String](https://leetcode-cn.com/tag/string) [Binary Tree](https://leetcode-cn.com/tag/binary-tree) 
