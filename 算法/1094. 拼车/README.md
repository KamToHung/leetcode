...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [前缀和](https://leetcode-cn.com/tag/prefix-sum) [排序](https://leetcode-cn.com/tag/sorting) [模拟](https://leetcode-cn.com/tag/simulation) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 
 ### 相似题目
