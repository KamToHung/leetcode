...
**标签:**  [字典树](https://leetcode-cn.com/tag/trie) [双指针](https://leetcode-cn.com/tag/two-pointers) [字符串](https://leetcode-cn.com/tag/string) [字符串匹配](https://leetcode-cn.com/tag/string-matching) 