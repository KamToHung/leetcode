...
**标签:**  [贪心](https://leetcode-cn.com/tag/greedy) [字符串](https://leetcode-cn.com/tag/string) [回溯](https://leetcode-cn.com/tag/backtracking) [计数](https://leetcode-cn.com/tag/counting) [枚举](https://leetcode-cn.com/tag/enumeration) 