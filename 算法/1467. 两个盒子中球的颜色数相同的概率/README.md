...
**标签:**  [数学](https://leetcode-cn.com/tag/math) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [回溯](https://leetcode-cn.com/tag/backtracking) [组合数学](https://leetcode-cn.com/tag/combinatorics) [概率与统计](https://leetcode-cn.com/tag/probability-and-statistics) 