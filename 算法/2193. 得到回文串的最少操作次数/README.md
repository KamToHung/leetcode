...
**标签:**  [贪心](https://leetcode-cn.com/tag/greedy) [树状数组](https://leetcode-cn.com/tag/binary-indexed-tree) [双指针](https://leetcode-cn.com/tag/two-pointers) [字符串](https://leetcode-cn.com/tag/string) 