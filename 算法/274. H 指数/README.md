...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [计数排序](https://leetcode-cn.com/tag/counting-sort) [排序](https://leetcode-cn.com/tag/sorting) 
 ### 相似题目
- 中等:	[H 指数 II](https://leetcode-cn.com/problems/h-index-ii) 
