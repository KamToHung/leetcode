...
**标签:**  [数学](https://leetcode-cn.com/tag/math) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [滑动窗口](https://leetcode-cn.com/tag/sliding-window) [概率与统计](https://leetcode-cn.com/tag/probability-and-statistics) 