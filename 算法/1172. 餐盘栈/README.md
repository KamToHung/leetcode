...
**标签:**  [栈](https://leetcode-cn.com/tag/stack) [设计](https://leetcode-cn.com/tag/design) [哈希表](https://leetcode-cn.com/tag/hash-table) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 