...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [队列](https://leetcode-cn.com/tag/queue) [数组](https://leetcode-cn.com/tag/array) [链表](https://leetcode-cn.com/tag/linked-list) [数据流](https://leetcode-cn.com/tag/data-stream) 