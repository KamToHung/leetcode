...
**Related Topics**  [Design](https://leetcode-cn.com/tag/design) [Ordered Set](https://leetcode-cn.com/tag/ordered-set) 

### Similar Question
 - Medium:	[Maximize Distance to Closest Person](https://leetcode-cn.com/problems/maximize-distance-to-closest-person) 
