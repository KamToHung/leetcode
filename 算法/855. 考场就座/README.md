...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [有序集合](https://leetcode-cn.com/tag/ordered-set) 
 ### 相似题目
- 中等:	[到最近的人的最大距离](https://leetcode-cn.com/problems/maximize-distance-to-closest-person) 
