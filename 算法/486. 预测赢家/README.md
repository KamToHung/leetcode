...
**标签:**  [递归](https://leetcode-cn.com/tag/recursion) [数组](https://leetcode-cn.com/tag/array) [数学](https://leetcode-cn.com/tag/math) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [博弈](https://leetcode-cn.com/tag/game-theory) 
 ### 相似题目
