...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [线段树](https://leetcode-cn.com/tag/segment-tree) [数组](https://leetcode-cn.com/tag/array) [二分查找](https://leetcode-cn.com/tag/binary-search) 