...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [数学](https://leetcode-cn.com/tag/math) [数论](https://leetcode-cn.com/tag/number-theory) [模拟](https://leetcode-cn.com/tag/simulation) 