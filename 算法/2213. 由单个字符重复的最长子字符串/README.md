...
**标签:**  [线段树](https://leetcode-cn.com/tag/segment-tree) [数组](https://leetcode-cn.com/tag/array) [字符串](https://leetcode-cn.com/tag/string) [有序集合](https://leetcode-cn.com/tag/ordered-set) 