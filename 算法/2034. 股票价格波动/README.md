...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [哈希表](https://leetcode-cn.com/tag/hash-table) [数据流](https://leetcode-cn.com/tag/data-stream) [有序集合](https://leetcode-cn.com/tag/ordered-set) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 