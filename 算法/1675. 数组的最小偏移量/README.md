...
**标签:**  [贪心](https://leetcode-cn.com/tag/greedy) [数组](https://leetcode-cn.com/tag/array) [有序集合](https://leetcode-cn.com/tag/ordered-set) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 