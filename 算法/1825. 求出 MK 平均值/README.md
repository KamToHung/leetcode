...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [队列](https://leetcode-cn.com/tag/queue) [有序集合](https://leetcode-cn.com/tag/ordered-set) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 