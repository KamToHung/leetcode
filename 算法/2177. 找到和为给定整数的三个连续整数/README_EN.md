...
# [2177. Find Three Consecutive Integers That Sum to a Given Number](https://leetcode-cn.com/problems/find-three-consecutive-integers-that-sum-to-a-given-number)
 ### Description
...
**Related Topics**  [Math](https://leetcode-cn.com/tag/math) [Simulation](https://leetcode-cn.com/tag/simulation) 