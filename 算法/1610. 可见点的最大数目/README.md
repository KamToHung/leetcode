...
**标签:**  [几何](https://leetcode-cn.com/tag/geometry) [数组](https://leetcode-cn.com/tag/array) [数学](https://leetcode-cn.com/tag/math) [排序](https://leetcode-cn.com/tag/sorting) [滑动窗口](https://leetcode-cn.com/tag/sliding-window) 