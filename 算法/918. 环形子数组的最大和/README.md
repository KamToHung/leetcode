...
**标签:**  [队列](https://leetcode-cn.com/tag/queue) [数组](https://leetcode-cn.com/tag/array) [分治](https://leetcode-cn.com/tag/divide-and-conquer) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [单调队列](https://leetcode-cn.com/tag/monotonic-queue) 