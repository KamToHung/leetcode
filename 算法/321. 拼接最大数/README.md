...
**标签:**  [栈](https://leetcode-cn.com/tag/stack) [贪心](https://leetcode-cn.com/tag/greedy) [单调栈](https://leetcode-cn.com/tag/monotonic-stack) 
 ### 相似题目
- 中等:	[移掉 K 位数字](https://leetcode-cn.com/problems/remove-k-digits) 
