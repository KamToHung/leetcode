...
**Related Topics**  [Stack](https://leetcode-cn.com/tag/stack) [Greedy](https://leetcode-cn.com/tag/greedy) [Monotonic Stack](https://leetcode-cn.com/tag/monotonic-stack) 

### Similar Questions
 - Medium:	[Remove K Digits](https://leetcode-cn.com/problems/remove-k-digits) 
 - Medium:	[Maximum Swap](https://leetcode-cn.com/problems/maximum-swap) 
