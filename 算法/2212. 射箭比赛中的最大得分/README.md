...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [递归](https://leetcode-cn.com/tag/recursion) [数组](https://leetcode-cn.com/tag/array) [枚举](https://leetcode-cn.com/tag/enumeration) 