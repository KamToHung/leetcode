...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [二分查找](https://leetcode-cn.com/tag/binary-search) [前缀和](https://leetcode-cn.com/tag/prefix-sum) [排序](https://leetcode-cn.com/tag/sorting) 