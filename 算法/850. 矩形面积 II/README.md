...
**标签:**  [线段树](https://leetcode-cn.com/tag/segment-tree) [数组](https://leetcode-cn.com/tag/array) [有序集合](https://leetcode-cn.com/tag/ordered-set) [扫描线](https://leetcode-cn.com/tag/line-sweep) 