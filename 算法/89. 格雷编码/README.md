...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [数学](https://leetcode-cn.com/tag/math) [回溯](https://leetcode-cn.com/tag/backtracking) 
 ### 相似题目
- 简单:	[1 比特与 2 比特字符](https://leetcode-cn.com/problems/1-bit-and-2-bit-characters) 
