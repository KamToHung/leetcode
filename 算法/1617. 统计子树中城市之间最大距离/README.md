...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [树](https://leetcode-cn.com/tag/tree) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [状态压缩](https://leetcode-cn.com/tag/bitmask) [枚举](https://leetcode-cn.com/tag/enumeration) 