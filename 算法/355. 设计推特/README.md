...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [哈希表](https://leetcode-cn.com/tag/hash-table) [链表](https://leetcode-cn.com/tag/linked-list) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 