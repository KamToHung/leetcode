...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [线段树](https://leetcode-cn.com/tag/segment-tree) [数学](https://leetcode-cn.com/tag/math) [有序集合](https://leetcode-cn.com/tag/ordered-set) 