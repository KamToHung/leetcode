...
**标签:**  [栈](https://leetcode-cn.com/tag/stack) [递归](https://leetcode-cn.com/tag/recursion) [哈希表](https://leetcode-cn.com/tag/hash-table) [字符串](https://leetcode-cn.com/tag/string) 
 ### 相似题目
...
- 困难:	[基本计算器 IV](https://leetcode-cn.com/problems/basic-calculator-iv) 
