...
**标签:**  [树](https://leetcode-cn.com/tag/tree) [深度优先搜索](https://leetcode-cn.com/tag/depth-first-search) [广度优先搜索](https://leetcode-cn.com/tag/breadth-first-search) [哈希表](https://leetcode-cn.com/tag/hash-table) [二叉树](https://leetcode-cn.com/tag/binary-tree) 