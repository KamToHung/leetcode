...
**Related Topics**  [Linked List](https://leetcode-cn.com/tag/linked-list) [Sorting](https://leetcode-cn.com/tag/sorting) 

### Similar Questions
 - Medium:	[Sort List](https://leetcode-cn.com/problems/sort-list) 
 - Medium:	[Insert into a Sorted Circular Linked List](https://leetcode-cn.com/problems/insert-into-a-sorted-circular-linked-list) 
