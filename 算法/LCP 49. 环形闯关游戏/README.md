...
- `1 <= challenge[i] <= 10^18`
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [并查集](https://leetcode-cn.com/tag/union-find) [数组](https://leetcode-cn.com/tag/array) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 