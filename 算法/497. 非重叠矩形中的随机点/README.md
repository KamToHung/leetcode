...
**标签:**  [水塘抽样](https://leetcode-cn.com/tag/reservoir-sampling) [数学](https://leetcode-cn.com/tag/math) [二分查找](https://leetcode-cn.com/tag/binary-search) [有序集合](https://leetcode-cn.com/tag/ordered-set) [前缀和](https://leetcode-cn.com/tag/prefix-sum) [随机化](https://leetcode-cn.com/tag/randomized) 
 ### 相似题目
