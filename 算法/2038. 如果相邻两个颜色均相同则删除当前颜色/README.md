...
**标签:**  [贪心](https://leetcode-cn.com/tag/greedy) [数学](https://leetcode-cn.com/tag/math) [字符串](https://leetcode-cn.com/tag/string) [博弈](https://leetcode-cn.com/tag/game-theory) 