...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [二分查找](https://leetcode-cn.com/tag/binary-search) [有序集合](https://leetcode-cn.com/tag/ordered-set) 
 ### 相似题目
- 简单:	[汇总区间](https://leetcode-cn.com/problems/summary-ranges) 
