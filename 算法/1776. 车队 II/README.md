...
**标签:**  [栈](https://leetcode-cn.com/tag/stack) [数组](https://leetcode-cn.com/tag/array) [数学](https://leetcode-cn.com/tag/math) [单调栈](https://leetcode-cn.com/tag/monotonic-stack) [堆（优先队列）](https://leetcode-cn.com/tag/heap-priority-queue) 