...
# [2025. 分割数组的最多方案数](https://leetcode-cn.com/problems/maximum-number-of-ways-to-partition-an-array)
...
**标签:**  [数组](https://leetcode-cn.com/tag/array) [哈希表](https://leetcode-cn.com/tag/hash-table) [计数](https://leetcode-cn.com/tag/counting) [枚举](https://leetcode-cn.com/tag/enumeration) [前缀和](https://leetcode-cn.com/tag/prefix-sum) 