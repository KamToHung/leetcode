...
**标签:**  [位运算](https://leetcode-cn.com/tag/bit-manipulation) [字符串](https://leetcode-cn.com/tag/string) [动态规划](https://leetcode-cn.com/tag/dynamic-programming) [回溯](https://leetcode-cn.com/tag/backtracking) [状态压缩](https://leetcode-cn.com/tag/bitmask) 